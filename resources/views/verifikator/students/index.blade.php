<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-black leading-tight">Data Mahasiswa</h2>
        <p class="text-sm text-gray-500">Daftar mahasiswa pada program studi Anda</p>
    </x-slot>
            ...
            <div class="bg-white rounded-lg shadow-sm overflow-x-auto">
                <table class="min-w-full text-sm">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr><td class="p-6 text-center text-gray-500" colspan="5">Belum ada data.</td></tr>
                        @endforelse
                    </tbody>
                </table>
