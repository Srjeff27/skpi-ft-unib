    ...
    <nav class="bg-white rounded-xl shadow-sm border border-gray-100 p-3 text-sm">
        ...
        @if ($isAdminArea)
            <a href="{{ route('admin.dashboard') }}"
                class="block rounded px-3 py-2 {{ request()->routeIs('admin.dashboard') ? 'bg-[#1b3985] text-white' : 'text-gray-900 hover:bg-blue-50' }}">Dashboard</a>
            <a href="{{ route('admin.students.index') }}"
                class="mt-1 block rounded px-3 py-2 {{ request()->routeIs('admin.students.*') ? 'bg-[#1b3985] text-white' : 'text-gray-900 hover:bg-blue-50' }}">Manajemen
                Mahasiswa</a>
            <a href="{{ route('admin.verifikators.index') }}"
                class="mt-1 block rounded px-3 py-2 {{ request()->routeIs('admin.verifikators.*') ? 'bg-[#1b3985] text-white' : 'text-gray-900 hover:bg-blue-50' }}">Manajemen
                Verifikator</a>
            ...
            <a href="{{ route('admin.prodis.index') }}"
                class="block rounded px-3 py-2 {{ request()->routeIs('admin.prodis.*') ? 'bg-[#1b3985] text-white' : 'text-gray-900 hover:bg-blue-50' }}">Program
                Studi</a>
            <a href="{{ route('admin.cpl.index') }}"
                class="mt-1 block rounded px-3 py-2 {{ request()->routeIs('admin.cpl.*') ? 'bg-[#1b3985] text-white' : 'text-gray-900 hover:bg-blue-50' }}">Kurikulum
                & CPL</a>

            <a href="{{ route('admin.portfolio-categories.index') }}"
                class="mt-3 block rounded px-3 py-2 {{ request()->routeIs('admin.portfolio-categories.*') ? 'bg-[#1b3985] text-white' : 'text-gray-900 hover:bg-blue-50' }}">Manajemen
                Kategori Portofolio</a>
            <div class="mt-3 mb-1 px-3 text-xs font-semibold text-gray-400">SKPI</div>
            <a href="{{ route('admin.portfolios.index') }}"
                class="block rounded px-3 py-2 {{ request()->routeIs('admin.portfolios.*') ? 'bg-[#1b3985] text-white' : 'text-gray-900 hover:bg-blue-50' }}">Manajemen
                Data SKPI</a>
            <a href="{{ route('admin.cetak_skpi.index') }}"
                class="mt-1 block rounded px-3 py-2 {{ request()->routeIs('admin.cetak_skpi.*') ? 'bg-[#1b3985] text-white' : 'text-gray-900 hover:bg-blue-50' }}">Cetak
                SKPI</a>

            <a href="{{ route('admin.announcements.index') }}"
                class="mt-3 block rounded px-3 py-2 {{ request()->routeIs('admin.announcements.*') ? 'bg-[#1b3985] text-white' : 'text-gray-900 hover:bg-blue-50' }}">Pengumuman</a>
            <a href="{{ route('admin.reports.index') }}"
                class="mt-1 block rounded px-3 py-2 {{ request()->routeIs('admin.reports.*') ? 'bg-[#1b3985] text-white' : 'text-gray-900 hover:bg-blue-50' }}">Monitoring
                & Laporan</a>
            <a href="{{ route('admin.finalisasi.index') }}"
                class="mt-1 block rounded px-3 py-2 {{ request()->routeIs('admin.finalisasi.*') ? 'bg-[#1b3985] text-white' : 'text-gray-900 hover:bg-blue-50' }}">Finalisasi
                Data</a>
            <a href="{{ route('admin.penerbitan.index') }}"
                class="mt-1 block rounded px-3 py-2 {{ request()->routeIs('admin.penerbitan.*') ? 'bg-[#1b3985] text-white' : 'text-gray-900 hover:bg-blue-50' }}">Penerbitan
                SKPI</a>
            <a href="{{ route('admin.pejabat.index') }}"
                class="mt-1 block rounded px-3 py-2 {{ request()->routeIs('admin.pejabat.*') ? 'bg-[#1b3985] text-white' : 'text-gray-900 hover:bg-blue-50' }}">Kelola
                Pejabat</a>
            <a href="{{ route('admin.system_settings.index') }}"
                class="mt-1 block rounded px-3 py-2 {{ request()->routeIs('admin.system_settings.*') ? 'bg-[#1b3985] text-white' : 'text-gray-900 hover:bg-blue-50' }}">Pengaturan
                Sistem</a>
